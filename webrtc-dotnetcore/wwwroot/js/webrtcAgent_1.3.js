...
//var connection = new signalR.HubConnectionBuilder().withUrl("https://agent.micred.am/WebRTCHub").build();
var connection = new signalR.HubConnectionBuilder().withUrl("https://localhost:60532/WebRTCHub").build();
...
//    {
//        'url': 'turn:34.242.213.188:3478?transport=udp',
//        'credential': 'test',
//        'username': 'test'
//    },
//    {
//        'url': 'turn:34.242.213.188:3478?transport=tcp',
//        'credential': 'test',
//        'username': 'test'
//    }
//    ]
...
/*const configuration = {*/
    //'iceServers': [{
    //    'urls': 'stun:stun.217.113.27.202:5349'
    //},
    //{
    //    'url': 'turn:turn.217.113.27.202:3478',
    //    'username': 'test',
    //    'credential': 'test123'
    //    }]
    ...
    //'iceServers': [
    //    {
    //        'urls': 'stun:74.125.128.127:19302'
    //    },

        //{
        //    'url': 'turn:eu-turn5.xirsys.com:3478?transport=udp',
        //    'credential': 'c60a6028-0fe0-11ec-a332-0242ac140004',
        //    'username': 'eVWZ9Yf04hqLCksi8eC37DFl_YBaXmgOiSaiZxvNrogV9nn71VahQHrKcmCemDXYAAAAAGE3ayVhbWF0c29sdXRpb24='
        //},
...
$(createRoomBtn).click(function () {
    ...
    connection.invoke("CreateRoom", userName).catch(function (err) {
        return console.error(err.toString());
    });
});
...
function sendFile() {
    ...
    reader.addEventListener('loadend', function (e) {
        ...
        FileInfo.append('FileContent', file);
        FileInfo.append('User', 'User');
        $.ajax({
            method: 'POST',
            url: '/Files/GetFile',
            data: FileInfo,
...
$(startbutton).click(function () {
    ...
    var fileInfo = dataURLtoFile(dataURL, 'picture.png');
    //console.log(fileInfo);

    var fileDetails = new FormData();
    fileDetails.append('FileContent', fileInfo);
    fileDetails.append('User', 'User');
...
function CreateActiveRoom() {
    ...
    var activRoom = { RoomId: myRoomId, RoomName: userName, AgentId: userId };

    $.ajax({
        method: 'POST',
        url: '/Micred/CreateNewActiveRoom',
        data: activRoom
    })
        .done(function (response) {

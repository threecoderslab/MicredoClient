...
(function (e) {
                    ...
                    for (var g = 0, f = d.length; g < f; g++) {
                        ...
                        if (h.key)
                            if (h.key === a) (b._buttonsHandled = !0), e(k).click();
                                ...
                                if (!h.key.altKey || b.altKey) if (!h.key.ctrlKey || b.ctrlKey) if (!h.key.metaKey || b.metaKey) (b._buttonsHandled = !0), e(k).click();
    ...
    l.defaults = {
        ...
        dom: {
            ...
            collection: { tag: "ul", className: "dropdown-menu" },
            button: { tag: "ActiveXObject" in q ? "li" : "button", className: "dt-button", active: "active", disabled: "disabled" },
